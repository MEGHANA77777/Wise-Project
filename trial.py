...
class ColorLinesGame:
    ...
    def show_game_over_dialog(self):
        ...
        play_again_button = tk.Button(button_frame, text="Play Again",
                                      ...
                                      bg=BUTTON_COLOR, fg=TEXT_COLOR, activebackground=BUTTON_HIGHLIGHT, padx=20,
                                      pady=10)
        play_again_button.pack(side="left", padx=10)

        exit_button = tk.Button(button_frame, text="Exit", command=self.master.quit, font=FONT_STYLE, bg="red",
